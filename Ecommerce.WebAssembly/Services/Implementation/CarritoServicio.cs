           ...
           try
            {
                ...
                if (encontrado != null)
                    _toastService.ShowSuccess("El producto fue actulizado");
                else _toastService.ShowSuccess("El producto fue agregado correctamente al carrito");

                MostrarItems.Invoke();
            }catch
            {
                _toastService.ShowError("No fue posible agregar al carrito");
            }
        }
